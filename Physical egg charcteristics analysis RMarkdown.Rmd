---
title: "Physical Properties of Robin Egg"
author: "Amelia Cox"
date: "March 18, 2019"
...
Shell3 is the same shell dataset, with oddly shaped eggs removed and elongation calculated 
...
###4.1 Albumen mass is correlated to incubation stage 
```{r}
...
###4.3 Albumen mass is not related to clutch size
...
###4.4 Albumen mass is not related to laying date. 
```{r}
...
###4.7 Yolk mass is correlated to laying order
...
###4.9 Yolk mass is not correlated to laying date
```{r}

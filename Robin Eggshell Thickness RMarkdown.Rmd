...
###4.1 Egg Volume
Removing the oddly small eggs that we want to remove for egg length
```{r}
...
```{r}
val <- read.csv("C:/Users/11arc/Dropbox/AmeliaBob/Robin/Shell thickness validation.csv") %>% arrange(Egg)
```
